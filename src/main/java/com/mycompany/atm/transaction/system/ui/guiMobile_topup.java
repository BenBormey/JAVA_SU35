 ...
 * @author HQ
 */
public class guiMobile_topup extends javax.swing.JFrame {

    /**
     * Creates new form guiMobile_topup
     */
    public guiMobile_topup() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        label1.setText("ATM System  Report Mobile Top up");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(28, 28, 28)
                .addComponent(label1, javax.swing.GroupLayout.PREFERRED_SIZE, 634, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnPriviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPriviewActionPerformed
        try {
            ...
            InputStream jrxml = getClass().getResourceAsStream("/Mobile_Top_up_Analysis.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(guiMobile_topup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new guiMobile_topup().setVisible(true);
            }
        });
    }
