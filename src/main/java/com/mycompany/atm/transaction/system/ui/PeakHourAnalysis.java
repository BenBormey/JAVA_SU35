 ...
 * @author HQ
 */
public class PeakHourAnalysis extends javax.swing.JFrame {

    /**
     * Creates new form PeakHourAnalysis
     */
    public PeakHourAnalysis() {
        initComponents();
    }
    ...
    private void btnPriviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPriviewActionPerformed
        try {
            ...
            InputStream jrxml = getClass().getResourceAsStream("/PeakHourAnalysis.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PeakHourAnalysis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PeakHourAnalysis().setVisible(true);
            }
        });
    }
